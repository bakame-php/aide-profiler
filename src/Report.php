...
final class Report implements JsonSerializable
{
    ...
    public static function fromArray(array $data): self
    {
        ...
        try {
            return new self(
                Statistics::fromArray($data['cpu_time']),
                Statistics::fromArray($data['execution_time']),
                Statistics::fromArray($data['memory_usage']),
                Statistics::fromArray($data['real_memory_usage']),
                Statistics::fromArray($data['peak_memory_usage']),
                Statistics::fromArray($data['real_peak_memory_usage']),
            );

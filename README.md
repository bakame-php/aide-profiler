...
If you need access to the complete set of statistical data rather than just average values, use the `Profiler::statistics` method.
...
including CPU time, execution time, and memory usage, offering a full performance profile.
